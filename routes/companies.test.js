...
test("unauthorized post", async function () {
  const resp = await request(app)
      .post("/companies")
      .send({
        handle: "newer",
...
describe("GET /companies", function () {
  ...
  test("one filtered companies",async function(){
  ...
  test("two filtered companies",async function(){
    const resp = await request(app).get("/companies?minEmployees=2&name=c3");
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("no companies found", async function () {
